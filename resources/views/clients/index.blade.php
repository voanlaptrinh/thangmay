...
<body class="font-sans text-ntd-dark bg-white">
                        ...
                        <div class="flex transition-transform duration-500 ease-out bg-transparent"
                            ...
                            @foreach ($thangmays as $thangmay)
                                <div class="w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-4">
                                    ...
                                    <div class="group bg-white rounded-[5px] overflow-hidden border-2 border-gray-200 hover:border-ntd-light transition duration-500 box-border"
                                        style="">
                                        @if ($thangmay->image)
                                ...
                                <div
                                    ...
                                    @if ($project->image)
                                        <img src="{{ asset($project->image) }}" alt="{{ $project->title }}"
                                            class="w-full object-cover project-image cursor-pointer"
                                            style="height: 480px; user-select: none; -webkit-tap-highlight-color: transparent;">
                                    @else
                                        <div class="w-full bg-gradient-to-br from-ntd-blue to-ntd-light flex items-center justify-center"
                                            style=" height: 480px;">
    ...
    <!-- Floating Buttons -->
    @if (get_config()->zalo_url)
        <a href="{{ get_config()->zalo_url }}" target="_blank" class="floating-btn floating-zalo"
            title="Chat Zalo">
    ...
    @if (get_config()->hotline)
        <a href="tel:{{ get_config()->hotline }}" class="floating-btn floating-phone"
            title="Gọi ngay: {{ get_config()->hotline }}">
